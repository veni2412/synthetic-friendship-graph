...
def generate_temporal_ba_graph(n=200, m=3, train_frac=0.7, seed=42):
    random.seed(seed)
    np.random.seed(seed)

    # Step 1: Generate full BA graph
    G_full = nx.barabasi_albert_graph(n=n, m=m, seed=seed)
...
if __name__ == "__main__":
    ...
    G_train, G_full, Eold, Enew = generate_temporal_ba_graph(n=200, m=3)
